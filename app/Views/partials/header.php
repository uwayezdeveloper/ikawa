            ...
            <div id="user-dropdown" class="topbar-item nav-user">
                <div class="dropdown">
                    <button class="topbar-link btn dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" type="button" aria-haspopup="false" aria-expanded="false">
                        <img src="<?= \App\Core\View::asset('images/users/user-1.jpg') ?>" alt="user-image" class="avatar-sm rounded-circle me-2" />
                        <span class="d-lg-flex flex-column gap-1 d-none">
                            <span class="fw-semibold"><?= $user['full_name'] ?? 'User' ?></span>
                            <span class="text-muted fs-10"><?= ucfirst($user['role'] ?? 'Guest') ?></span>
                        </span>
