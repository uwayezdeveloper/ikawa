...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"><?= htmlspecialchars($title ?? 'Add New Expense Type') ?></h4>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="ti ti-plus me-2"></i>Add New Expense Type
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <!-- Form -->
                <form method="POST" action="<?= APP_URL ?>/finance/expense-types/store" id="expenseTypeForm">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="expense_name" name="expense_name" 
                                       ...
                                       value="<?= htmlspecialchars($_SESSION['old_input']['expense_name'] ?? '') ?>">
                                ...
                                <select class="form-control" id="categ_id" name="categ_id">
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?= $category['categ_id'] ?>" 
                                                <?= ($_SESSION['old_input']['categ_id'] ?? '') == $category['categ_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" 
                                          ...
                                          maxlength="55"><?= htmlspecialchars($_SESSION['old_input']['description'] ?? '') ?></textarea>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="expense_status" name="expense_status">
                                    <option value="1" <?= ($_SESSION['old_input']['expense_status'] ?? 1) == 1 ? 'selected' : '' ?>>Active</option>
                                    <option value="0" <?= ($_SESSION['old_input']['expense_status'] ?? 1) == 0 ? 'selected' : '' ?>>Inactive</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-check me-1"></i>Save Expense Type
                        </button>
                    </div>
                </form>
            </div>
