...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"><?= htmlspecialchars($title ?? 'Expense Categories') ?></h4>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= APP_URL ?>/finance/expense-categories/create" class="btn btn-primary">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <form method="GET" action="<?= APP_URL ?>/finance/expense-categories" class="d-flex">
                            ...
                            <?php if (!empty($search)): ?>
                                <a href="<?= APP_URL ?>/finance/expense-categories" class="btn btn-outline-secondary ms-2">
                                    <i class="ti ti-x"></i>
                                </a>
                            <?php endif; ?>
                        </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?= APP_URL ?>/finance/expense-categories/<?= $category['categ_id'] ?>/edit" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    statusToggles.forEach(function(toggle) {
        toggle.addEventListener('change', function() {
            ...
            fetch(`<?= APP_URL ?>/finance/expense-categories/${categoryId}/toggle-status`, {
                method: 'POST',
                headers: {
    ...
    deleteButtons.forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            deleteForm.action = `<?= APP_URL ?>/finance/expense-categories/${categoryId}/delete`;
            deleteModal.show();
        });
    });
});
