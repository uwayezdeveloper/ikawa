...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"><?= htmlspecialchars($title ?? 'Edit Expense Consumer') ?></h4>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    <i class="ti ti-edit me-2"></i>Edit Expense Consumer
                </h5>
            </div>
            ...
            <div class="card-body">
                ...
                <!-- Form -->
                <form method="POST" action="<?= APP_URL ?>/finance/expense-consumers/<?= $consumer['cons_id'] ?>/update" id="consumerForm">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cons_name" name="cons_name" 
                                       ...
                                       value="<?= htmlspecialchars($_SESSION['old_input']['cons_name'] ?? $consumer['cons_name']) ?>">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" 
                                       ...
                                       value="<?= htmlspecialchars($_SESSION['old_input']['phone'] ?? $consumer['phone']) ?>">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="sts" name="sts">
                                    <?php $selectedStatus = $_SESSION['old_input']['sts'] ?? $consumer['sts']; ?>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-check me-1"></i>Update Consumer
                        </button>
                    </div>
                </form>
            </div>
