...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title"><?= htmlspecialchars($title ?? 'Edit Source of Income') ?></h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-8 col-md-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Edit Source of Income Information</h5>
            </div>
            ...
            <div class="card-body">
                ...
                <!-- Edit Form -->
                <form method="POST" action="<?= APP_URL ?>/finance/source-of-income/<?= $source['in_id'] ?>/update">
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               name="in_name" 
                               maxlength="50"
                               value="<?= htmlspecialchars($_SESSION['old_input']['in_name'] ?? $source['in_name']) ?>"
                               required
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  rows="3"
                                  maxlength="100"
                                  placeholder="Enter description (optional)"><?= htmlspecialchars($_SESSION['old_input']['in_descr'] ?? $source['in_descr'] ?? '') ?></textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="in_status" name="in_status" required>
                            <?php 
                            $currentStatus = $_SESSION['old_input']['in_status'] ?? $source['in_status'];
                            ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               class="form-control" 
                               value="<?= date('Y-m-d H:i', strtotime($source['reg_date'] ?? '')) ?>"
                               disabled>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="ti ti-device-floppy me-1"></i>Update Source
                        </button>
                    </div>
                </form>
