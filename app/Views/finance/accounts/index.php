        ...
        <table class="table table-custom table-centered table-hover w-100 mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span
                            class="badge bg-info-subtle text-info"><?= htmlspecialchars($account['location_name'] ?? '-') ?></span>
                        <br><small
                            class="text-muted"><?= htmlspecialchars($account['location_type_name'] ?? '') ?></small>
                    </td>
                    <td>
                        <span
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="locationTypeId" class="form-label">Location Type <span
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="paymentModeId" class="form-label">Payment Mode <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="accountName" class="form-label">Account Name <span
                                class="text-danger">*</span></label>
        ...
        <div class="modal-content">
            ...
            <form action="<?= APP_URL ?>/finance/accounts" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="editLocationTypeId" class="form-label">Location Type <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="editPaymentModeId" class="form-label">Payment Mode <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label for="editAccountName" class="form-label">Account Name <span
                                class="text-danger">*</span></label>
            ...
            .then(data => {
                if (data.success) {
                    ...
                    data.locations.forEach(function(location) {
                        const selected = selectedLocationId && location.id == selectedLocationId ?
                            'selected' : '';
                        options +=
    ...
    document.querySelectorAll('.btn-edit-account').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            loadLocations(this.dataset.locationTypeId, document.getElementById(
                'editLocationId'), this.dataset.locationId);
        });
    });
