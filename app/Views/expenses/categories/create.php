    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0"><?= htmlspecialchars($title ?? 'Add New Expense Category') ?></h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#">Expense Management</a></li>
                        <li class="breadcrumb-item"><a href="/expenses/categories">Expense Categories</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="bx bx-plus me-2"></i>Add New Expense Category
                    </h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <!-- Form -->
                    <form method="POST" action="/expenses/categories/store" id="categoryForm">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="categ_name" name="categ_name" 
                                           ...
                                           value="<?= htmlspecialchars($_SESSION['old_input']['categ_name'] ?? '') ?>">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" 
                                              ...
                                              maxlength="50"><?= htmlspecialchars($_SESSION['old_input']['description'] ?? '') ?></textarea>
                                    <div class="form-text">Maximum 50 characters</div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        <option value="1" <?= ($_SESSION['old_input']['status'] ?? 1) == 1 ? 'selected' : '' ?>>Active</option>
                                        <option value="0" <?= ($_SESSION['old_input']['status'] ?? 1) == 0 ? 'selected' : '' ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/expenses/categories" class="btn btn-secondary">
