...
$canCreate = $isSuperAdmin || in_array('certification', $menuAccess);
$canEdit = $isSuperAdmin || in_array('certification', $menuAccess);
$canDelete = $isSuperAdmin || in_array('certification', $menuAccess);
?>
