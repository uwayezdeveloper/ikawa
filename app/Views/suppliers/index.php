...
$canCreate = $isSuperAdmin || in_array('suppliers', $menuAccess);
$canEdit = $isSuperAdmin || in_array('suppliers', $menuAccess);
$canDelete = $isSuperAdmin || in_array('suppliers', $menuAccess);
?>
