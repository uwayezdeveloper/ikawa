...
$canCreate = $isSuperAdmin || in_array('product-categories', $menuAccess);
$canEdit = $isSuperAdmin || in_array('product-categories', $menuAccess);
$canDelete = $isSuperAdmin || in_array('product-categories', $menuAccess);
?>
    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="<?= APP_URL ?>/products">Products</a></li>
                ...
                <tr>
                    ...
                    <td>
                        <h5 class="fs-base mb-0">
                            <a href="#" class="link-reset"><?= htmlspecialchars($category['name']) ?></a>
                        </h5>
                    </td>
                    <td>
                        <span class="text-muted"><?= htmlspecialchars($category['description'] ?? '-') ?></span>
                    </td>
                    ...
                    <td>
                        <div class="d-flex justify-content-center gap-1">
                            <?php if ($canEdit): ?>
                            <button type="button" class="btn btn-default btn-icon btn-sm btn-edit-category"
                                data-id="<?= $category['id'] ?>" 
                            ...
                            <?php endif; ?>
                            <?php if ($canDelete): ?>
                            <button type="button" class="btn btn-default btn-icon btn-sm btn-delete-category"
                                data-id="<?= $category['id'] ?>" 
                                data-name="<?= htmlspecialchars($category['name']) ?>">
...
<div class="modal fade" id="addCategoryModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= APP_URL ?>/products/categories" method="POST">
...
<?php if ($canDelete): ?>
<!-- Delete Form -->
<form id="deleteCategoryForm" action="<?= APP_URL ?>/products/categories" method="POST" style="display: none;">
