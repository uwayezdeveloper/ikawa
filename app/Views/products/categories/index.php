...
$canCreate = in_array('create-product-categories', $permissions);
$canEdit = in_array('edit-product-categories', $permissions);
$canDelete = in_array('delete-product-categories', $permissions);
?>
