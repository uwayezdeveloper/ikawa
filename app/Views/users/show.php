    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body text-center">
                            <?php
                $userAvatarUrl = !empty($viewUser['avatar']) ? APP_URL . '/' . $viewUser['avatar'] : \App\Core\View::asset('images/users/user-1.jpg');
                ?>
                <img src="<?= $userAvatarUrl ?>" alt="user"
                    class="avatar-xxl rounded-circle mb-3" style="object-fit: cover; width: 120px; height: 120px;" />
