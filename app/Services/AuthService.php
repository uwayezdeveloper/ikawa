...
class AuthService
{
    ...
    public function attempt(string $email, string $password): ?array
    {
        ...
        // Load menu-based access and compatibility permissions
        $menuIdentifiers = $this->userModel->getUserMenuIdentifiers($user['id']);
        $userWithRole['menu_identifiers'] = $menuIdentifiers;
        $userWithRole['permissions'] = $this->userModel->getLegacyPermissionsFromMenus($menuIdentifiers);
