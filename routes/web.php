...
use App\Controllers\AccountTransactionController;
use App\Controllers\StockReceiveController;
use App\Controllers\StockTransferController;
use App\Controllers\WarehouseController;
use App\Controllers\ProductionController;
use App\Controllers\StationFinanceController;
...
use App\Controllers\SupplierAdvanceController;
use App\Controllers\SupplierRecordController;
use App\Controllers\ProformaInvoiceController;
use App\Controllers\ProcessingStepController;
use App\Controllers\ClientController;
use App\Controllers\ClientTypeController;
use App\Controllers\WarehouseProcessingController;
use App\Controllers\WarehouseReceiveController;
...
$router->get('/profile/edit', [ProfileController::class, 'edit'], ['AuthMiddleware']);
$router->post('/profile/update', [ProfileController::class, 'update'], ['AuthMiddleware']);
$router->get('/profile/change-password', [ProfileController::class, 'changePassword'], ['AuthMiddleware']);
$router->post('/profile/update-password', [ProfileController::class, 'updatePassword'], ['AuthMiddleware']);
$router->post('/profile/avatar', [ProfileController::class, 'updateAvatar'], ['AuthMiddleware']);
$router->post('/profile/avatar/remove', [ProfileController::class, 'removeAvatar'], ['AuthMiddleware']);
...
$router->get('/settings/processing-steps', [ProcessingStepController::class, 'index'], ['AuthMiddleware', 'AdminMiddleware']);
$router->post('/settings/processing-steps', [ProcessingStepController::class, 'handleAction'], ['AuthMiddleware', 'AdminMiddleware']);
...
// Suppliers management - Supplier Advances
$router->get('/suppliers/advances', [SupplierAdvanceController::class, 'index'], ['AuthMiddleware', 'AdminMiddleware']);
$router->post('/suppliers/advances', [SupplierAdvanceController::class, 'handleAction'], ['AuthMiddleware', 'AdminMiddleware']);

// Suppliers management - Supplier Records
$router->get('/suppliers/records', [SupplierRecordController::class, 'index'], ['AuthMiddleware']);
$router->post('/suppliers/records/action', [SupplierRecordController::class, 'action'], ['AuthMiddleware']);
$router->get('/suppliers/records/download-pdf', [SupplierRecordController::class, 'downloadPdf'], ['AuthMiddleware']);
...
// Finance management - Account Transactions
$router->get('/finance/transactions', [AccountTransactionController::class, 'index'], ['AuthMiddleware', 'AdminMiddleware']);

// Finance management - Station Finances
$router->get('/finance/station-finances', [StationFinanceController::class, 'index'], ['AuthMiddleware']);
...
$router->get('/finance/station-finances/detailed-expense-report', [StationFinanceController::class, 'detailedExpenseReport'], ['AuthMiddleware']);

// Stock management - Receive Stock
$router->get('/stock/receives', [StockReceiveController::class, 'index'], ['AuthMiddleware']);
$router->post('/stock/receives/action', [StockReceiveController::class, 'handleAction'], ['AuthMiddleware']);

// Stock management - Stock Summary
$router->get('/stock/summary', [StockReceiveController::class, 'summary'], ['AuthMiddleware']);

// Stock management - Transfer to Warehouse
$router->get('/stock/transfers', [StockTransferController::class, 'index'], ['AuthMiddleware']);
$router->post('/stock/transfers/action', [StockTransferController::class, 'handleAction'], ['AuthMiddleware']);

// Warehouse management
$router->get('/warehouse/stock', [WarehouseController::class, 'stock'], ['AuthMiddleware']);
$router->get('/warehouse/incoming', [WarehouseController::class, 'incoming'], ['AuthMiddleware']);
$router->post('/warehouse/action', [WarehouseController::class, 'handleAction'], ['AuthMiddleware']);

// Warehouse processing - Record processing steps
$router->get('/warehouse/processing', [WarehouseProcessingController::class, 'index'], ['AuthMiddleware']);
$router->post('/warehouse/processing/action', [WarehouseProcessingController::class, 'handleAction'], ['AuthMiddleware']);

// Warehouse receive - Receive stock at warehouse
$router->get('/warehouse/receive', [WarehouseReceiveController::class, 'index'], ['AuthMiddleware']);
$router->post('/warehouse/receive/action', [WarehouseReceiveController::class, 'handleAction'], ['AuthMiddleware']);

// Warehouse sales - Sell from warehouse
$router->get('/warehouse/sales', [WarehouseSaleController::class, 'index'], ['AuthMiddleware']);
$router->get('/warehouse/sales/history', [WarehouseSaleController::class, 'history'], ['AuthMiddleware']);
$router->post('/warehouse/sales/action', [WarehouseSaleController::class, 'handleAction'], ['AuthMiddleware']);

// Production management
$router->get('/production', [ProductionController::class, 'index'], ['AuthMiddleware']);
$router->post('/production/action', [ProductionController::class, 'handleAction'], ['AuthMiddleware']);
