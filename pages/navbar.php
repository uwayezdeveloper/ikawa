        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="../img/logo/logo.png" alt="" style="width:100px;height:44px" /></a>
                    </div>
                </div>
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav notika-top-nav">
                            ...
                            <!--    </div>-->
                            <!--</li>-->
                            <li class="nav-item navbar-download-btn">
                                <a href="#" class="btn" data-toggle="tooltip" data-placement="bottom" title="Download Documentation">
